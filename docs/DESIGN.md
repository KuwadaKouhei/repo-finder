...
>内部の作り（コンポーネント分解・内部ロジック）は詳細設計書（DETAILED_DESIGN.md）に委ねる。
...
- キーワード検索、結果一覧、並び替え、ページ送り、リポジトリ詳細表示、GitHubページへの外部リンク
- 認証ログイン、無限スクロール、データ永続化
...
| 使用性 | WCAG 2.1 AA目安・キーボード完結・レスポンシブ |
